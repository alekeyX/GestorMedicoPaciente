...
router.put('/medic/password/:id', auth, medicCtrl.changePassword )
...
router.put('/patient/password/:id', auth, patientCtrl.changePassword )
router.put('/patient/:id', auth, upload.single('imagePath'), patientCtrl.updatePatient )
router.put('/patient/:id/:medic_id', auth, patientCtrl.medicAddPatient )
